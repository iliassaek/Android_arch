package com.example.iliass.architecture;
...
public class AddNoteActivity extends AppCompatActivity {
    ...
    private NumberPicker numberPickerPrioirity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        numberPickerPrioirity = findViewById(R.id.number_picker_priority);

        numberPickerPrioirity.setMinValue(1);
        numberPickerPrioirity.setMaxValue(10);
    ...
    private void saveNote() {
        ...
        int priority = numberPickerPrioirity.getValue() ;
